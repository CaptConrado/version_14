  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved claim as @claim" do
        ...
        post :create, {:claim => { "title" => "invalid value" }}, valid_session
        assigns(:claim).should be_a_new(Claim)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested claim" do
        ...
        Claim.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => claim.to_param, :claim => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the claim as @claim" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Claim.any_instance.stub(:save).and_return(false)
        put :update, {:id => claim.to_param, :claim => { "title" => "invalid value" }}, valid_session
        assigns(:claim).should eq(claim)
      end
