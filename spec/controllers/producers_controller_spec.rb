  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved producer as @producer" do
        ...
        post :create, {:producer => { "name" => "invalid value" }}, valid_session
        assigns(:producer).should be_a_new(Producer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested producer" do
        ...
        Producer.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => producer.to_param, :producer => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the producer as @producer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Producer.any_instance.stub(:save).and_return(false)
        put :update, {:id => producer.to_param, :producer => { "name" => "invalid value" }}, valid_session
        assigns(:producer).should eq(producer)
      end
